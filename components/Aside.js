...
export default function Aside() {
  ...
  let styleOpen = layotContext.isSidebarOpen
    ? "text-white bg-aside fixed inset-y-0 z-10 flex flex-col flex-shrink-0 w-56 max-h-screen overflow-hidden transition-all transform border-r shadow-lg lg:z-auto lg:static lg:shadow-none -translate-x-full lg:translate-x-0 lg:w-14"
    : "text-white bg-aside fixed inset-y-0 z-10 flex flex-col flex-shrink-0 w-56 max-h-screen overflow-hidden transition-all transform border-r shadow-lg lg:z-auto lg:static lg:shadow-none";
  ...
  let styleLink = layotContext.isSidebarOpen
    ? "flex items-center w-full p-2 space-x-2 rounded-md hover:bg-blue-700 justify-center"
    : "flex items-center w-full p-2 space-x-2 rounded-md hover:bg-blue-700";
      ...
      <aside className={styleOpen}>
        ...
        <div className={styleHeader}>
          <span className="p-2 text-lg font-bold leading-8 tracking-wider uppercase whitespace-nowrap">
            <Link href="/">
              <button className={styleHidden}>SISTEMA WEB</button>
            </Link>
          </span>
            ...
            <li>
              <Link href="/promociones">
                <button className={styleLink}>
                  ...
                  <span className={styleHidden}>Promociones</span>
                </button>
              </Link>
            </li>
          </ul>
