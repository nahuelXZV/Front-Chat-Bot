...
export default function Aside() {
  ...
  let styleOpen = layotContext.isSidebarOpen
    ? "text-white bg-blue-900 fixed inset-y-0 z-10 flex flex-col flex-shrink-0 w-48 max-h-screen overflow-hidden transition-all transform border-r shadow-lg lg:z-auto lg:static lg:shadow-none -translate-x-full lg:translate-x-0 lg:w-14"
    : "text-white bg-blue-900 fixed inset-y-0 z-10 flex flex-col flex-shrink-0 w-48 max-h-screen overflow-hidden transition-all transform border-r shadow-lg lg:z-auto lg:static lg:shadow-none";
